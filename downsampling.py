...
def scale_coordinates(coordinates, grid_size=(4, 4)):
    if not coordinates:
        return []
...
def draw_chain_code(grid_arrows, grid_size=(4, 4), img_size=(64, 64)):
...
def process_folder(input_folder, output_folder, grid_size=(4, 4), img_size=(64, 64)):
